...
const btnVerMas = document.querySelector(".logosA");
const btnVerMas2 = document.querySelector(".div6");
...
btnVerMas.addEventListener("click", irAVerMas);
btnVerMas2.addEventListener("click", irAVerMas);

autos.slice(0, 4).forEach(auto => {
